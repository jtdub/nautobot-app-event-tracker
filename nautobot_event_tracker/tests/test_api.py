"""Unit tests for nautobot_event_tracker."""
...
class EventTrackerExampleModelAPIViewTest(APIViewTestCases.APIViewTestCase):
    # pylint: disable=too-many-ancestors
    """Test the API viewsets for EventTrackerExampleModel."""
    ...
    def setUpTestData(cls):
        """Create test data for EventTrackerExampleModel API viewset."""
        super().setUpTestData()
