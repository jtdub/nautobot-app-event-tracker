...
!!! warning "Draft"
    This document was reconstructed from the system diagram supplied at project kickoff. It describes the **target** system across all phases. Only Phase 1 is implemented. Everything else is stated here so that Phase 1 does not paint later phases into a corner.
